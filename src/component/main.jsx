...
function Main() {
    return (
        <div id='main'>
            ...
            <img className='w-full h-screen object-cover object-left scale-x-[1]' src={bigbg} alt='jjj'></img>
    ...
    />
                ...
                <a href="https://drive.google.com/file/d/1wWaWHR8N2Xq1imDb0HSKaMWZDyMOs4ry/view" target="_blank" rel="noopener noreferrer"> <BsPerson className='cursor-pointer' size={20}/></a>
